...
var streamParser = function (_Transform) {
	...
	function streamParser(END) {
		_classCallCheck(this, streamParser);

		var _this = _possibleConstructorReturn(this, (streamParser.__proto__ || Object.getPrototypeOf(streamParser)).call(this));
